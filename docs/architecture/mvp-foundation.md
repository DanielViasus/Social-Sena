...
- React renderiza la sala y los jugadores dentro del viewport principal
- El renderer React recibe `RoomState` y actualiza el mundo sin mezclar networking con render
...
- `apps/web/src/components/ReactWorld.tsx` resuelve el render del mundo del cliente
...
- personajes renderizados con React y sprites SVG por frames
